subroutine estimate_timestep
  ...
  dt_stable_phase_field = -(dpf*dpf)/(8*min(M_pht_env*sigma_pht_env,M_pht_met*sigma_pht_met,M_pht_pyr*sigma_pht_pyr_0,M_met_env*sigma_met_env,M_met_pyr*sigma_met_pyr_0,M_env_pyr*sigma_env_pyr_0))
