...
!!!! Define dissolution rates (in nm/s)
  ...
  diss_rate_pht = 289.15*exp(0.0d0-(65900/(R*T)))*(10**(-1.46*pH_in)) !! REF = "Pyrrhotite dissolution in acidic media" Chirita.P. et.al. Applied Geochemistry 41 (2014) 1-10. DOI: 10.1016/j.apgeochem.2013.11.013
  ...
  diss_rate_env = 0.015d0
     ...
     do x = 1,psx
        do y = 1,psy
           do z = psz+ghost_width-1,1+ghost_width,-1
